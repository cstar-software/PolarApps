...
function ff() {
  ...
  this.videoExt = '.mp4',
  // this.filter = '"[0]scale=iw/32:ih/32 [pip]; [1][pip] overlay=main_w-overlay_w-10:main_h-overlay_h-10"',
  this.filter = '"[0]scale=128:80 [pip]; [1][pip] overlay=main_w-overlay_w-10:main_h-overlay_h-10"',
